...
/// has to be resolved into memory first — once, here, rather than at each
...
/// raw `ArgumentError` on the cold-start path, outside the `try` that catches
...
/// stops the app running unpinned for ever; the trust prompt is what happens
/// next.
