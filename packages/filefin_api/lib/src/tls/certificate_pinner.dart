...
/// caller-driven act. It records the last certificate seen per `host:port`
/// because by the time dio surfaces the failure the callback is long gone and
/// the exception carries only a `HandshakeException`.
